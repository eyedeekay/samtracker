...
//Option is a SamTracker Option
type Option func(*SamTracker) error

//SetFilePath sets the path to save the config file at.
func SetFilePath(s string) func(*SamTracker) error {
...
func SetType(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if s == "http" {
...
func SetSigType(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if s == "" {
...
func SetSaveFile(b bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
func SetHost(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
func SetPort(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
//SetSAMHost sets the host of the SamTracker's SAM bridge
func SetSAMHost(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
//SetSAMPort sets the port of the SamTracker's SAM bridge using a string
func SetSAMPort(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
		port, err := strconv.Atoi(s)
		if err != nil {
...
//SetName sets the host of the SamTracker's SAM bridge
func SetName(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
func SetInLength(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if u < 7 && u >= 0 {
...
func SetOutLength(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if u < 7 && u >= 0 {
...
func SetInVariance(i int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if i < 7 && i > -7 {
...
func SetOutVariance(i int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if i < 7 && i > -7 {
...
func SetInQuantity(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if u <= 16 && u > 0 {
...
func SetOutQuantity(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if u <= 16 && u > 0 {
...
func SetInBackups(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if u < 6 && u >= 0 {
...
func SetOutBackups(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if u < 6 && u >= 0 {
...
func SetEncrypt(b bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if b {
...
func SetServeDir(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
		var err error
...
//SetLeaseSetKey sets the host of the SamTracker's SAM bridge
func SetLeaseSetKey(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
//SetLeaseSetPrivateKey sets the host of the SamTracker's SAM bridge
func SetLeaseSetPrivateKey(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
//SetLeaseSetPrivateSigningKey sets the host of the SamTracker's SAM bridge
func SetLeaseSetPrivateSigningKey(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
//SetMessageReliability sets the host of the SamTracker's SAM bridge
func SetMessageReliability(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
func SetAllowZeroIn(b bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if b {
...
func SetAllowZeroOut(b bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if b {
...
func SetCompress(b bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if b {
...
func SetFastRecieve(b bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if b {
...
func SetReduceIdle(b bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if b {
...
func SetReduceIdleTime(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
func SetReduceIdleTimeMs(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		c.SAMForwarder.Config().ReduceIdleTime = 300000
		if u >= 300000 {
...
func SetReduceIdleQuantity(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if u < 5 {
...
func SetCloseIdle(b bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if b {
...
func SetCloseIdleTime(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
func SetCloseIdleTimeMs(u int) func(*SamTracker) error {
	return func(c *SamTracker) error {
		c.SAMForwarder.Config().CloseIdleTime = 300000
		if u >= 300000 {
...
func SetAccessListType(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if s == "whitelist" {
...
func SetAccessList(s []string) func(*SamTracker) error {
	return func(c *SamTracker) error {
		if len(s) > 0 {
			for _, a := range s {
...
//SetTargetForPort sets the port of the SamTracker's SAM bridge using a string
/*func SetTargetForPort443(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
		port, err := strconv.Atoi(s)
		if err != nil {
...
//SetKeyFile sets
func SetKeyFile(s string) func(*SamTracker) error {
	return func(c *SamTracker) error {
...
//SetDebugTracker sets
func SetDebugTracker(s bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
		c.config.Debug = s
		return nil
	}
...
//SetXReal sets
func SetXReal(s bool) func(*SamTracker) error {
	return func(c *SamTracker) error {
		c.config.XRealIP = s
		return nil
	}
